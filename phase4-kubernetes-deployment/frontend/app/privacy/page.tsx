        ...
        <div className="glass-card p-8 md:p-12 space-y-8 border border-white/20 dark:border-[#252E8A]/20">
          ...
          <div className="prose dark:prose-invert max-w-none text-gray-600 dark:text-gray-400 space-y-6">
            ...
            <section>
              ...
              <p>Welcome to TodoBoard. We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about our policy, or our practices with regards to your personal information, please contact us.</p>
            </section>
