...
import { Target, Zap, BarChart3, CheckCircle2, ArrowRight, Calendar, Bell, Users, TrendingUp, Shield, Sparkles, Layers, Clock } from 'lucide-react'
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[#F7F6F7] via-white to-[#D6E6F2] dark:from-[#0E0E34] dark:via-[#252E8A] dark:to-[#0E0E34]">
      ...
      <section className="relative flex items-center px-4 sm:px-6 lg:px-8 pt-32 pb-12 min-h-[600px] overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <motion.div
            ...
            style={{
              background: 'radial-gradient(circle, rgba(110,184,225,0.1) 0%, transparent 70%)'
            }}
          />
          <motion.div
            animate={{
            ...
            style={{
              background: 'radial-gradient(circle, rgba(200,171,230,0.1) 0%, transparent 70%)'
            }}
          />
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-muted-foreground leading-relaxed max-w-2xl mx-auto lg:mx-0">
                From simple lists to intelligent insights, the last todo app you'll ever need. Stay focused, get organized, and achieve more every day.
              </p>
            ...
            >
              <div className="relative aspect-square max-w-lg mx-auto">
                ...
                >
                  {/* Card 1 - Blue */}
                  <div className="absolute top-0 left-0 right-12 glass-card p-6 rounded-2xl border-2 shadow-2xl"
                    style={{ borderColor: '#6EB8E1', boxShadow: '0 20px 60px rgba(110, 184, 225, 0.2)' }}
                  >
                    <div className="flex items-start space-x-4">
                      <div className="mt-1">
                        <CheckCircle2 className="h-6 w-6" style={{ color: '#6EB8E1' }} />
                      </div>
                      <div className="flex-1 space-y-2">
                        <div className="h-3 rounded w-3/4" style={{ backgroundColor: '#D6E6F2' }}></div>
                        <div className="h-2 rounded w-full" style={{ backgroundColor: '#E6E5E1' }}></div>
                        <div className="h-2 rounded w-2/3" style={{ backgroundColor: '#E6E5E1' }}></div>
                      </div>
                    </div>
                  </div>

                  {/* Card 2 - Purple */}
                  <div className="absolute top-24 left-12 right-0 glass-card p-6 rounded-2xl border-2 shadow-2xl"
                    style={{ borderColor: '#C8ABE6', boxShadow: '0 20px 60px rgba(200, 171, 230, 0.2)' }}
                  >
                    <div className="flex items-start space-x-4">
                      <div className="mt-1">
                        <Target className="h-6 w-6" style={{ color: '#C8ABE6' }} />
                      </div>
                      <div className="flex-1 space-y-2">
                        <div className="h-3 rounded w-2/3" style={{ backgroundColor: '#DBD6F4' }}></div>
                        <div className="h-2 rounded w-full" style={{ backgroundColor: '#E6E5E1' }}></div>
                      </div>
                    </div>
                  </div>
                  ...
                  {/* Card 3 - Teal */}
                  <div className="absolute top-48 left-0 right-12 glass-card p-6 rounded-2xl border-2 shadow-2xl"
                    style={{ borderColor: '#4EB5A9', boxShadow: '0 20px 60px rgba(78, 181, 169, 0.2)' }}
                  >
                    <div className="flex items-start space-x-4">
                      <div className="mt-1">
                      ...
                      <div className="flex-1 space-y-2">
                        <div className="h-3 rounded w-1/2" style={{ backgroundColor: '#BAD0CC' }}></div>
                        <div className="h-2 rounded w-5/6" style={{ backgroundColor: '#E6E5E1' }}></div>
                      </div>
                    </div>
                  </div>
                </motion.div>
      ...
      {/* Features Section */}
      <section id="features" className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-[#FBE5E7] dark:from-[#0E0E34] dark:to-[#252E8A]">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              <span className="text-sm font-bold uppercase tracking-wider" style={{ color: '#5A7FC8' }}>Features</span>
            </motion.div>
                ...
                >
                  ...
                  >
                    <div className="relative space-y-4">
                      ...
                      >
                        <Icon className="h-6 w-6" style={{ color: '#6EB8E1' }} />
                      </motion.div>
                    ...
                    <div
                      ...
                      style={{
                        background: 'linear-gradient(90deg, #6EB8E1 0%, #4EB5A9 100%)'
                      }}
                    />
                  </motion.div>
                </motion.div>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white via-[#F7F6F7] to-[#E6E5E1] dark:from-[#252E8A] dark:to-[#0E0E34]">
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            className="text-center mb-16 space-y-4"
          >
            <span className="text-sm font-bold uppercase tracking-wider" style={{ color: '#C8ABE6' }}>How It Works</span>
            <h2 className="text-3xl sm:text-4xl font-display font-extrabold text-foreground tracking-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {howItWorks.map((item, index) => {
              ...
              const colors = [
                { gradient: 'linear-gradient(135deg, #6EB8E1 0%, #5A7FC8 100%)', shadow: 'rgba(110, 184, 225, 0.25)', border: '#6EB8E1' },
                { gradient: 'linear-gradient(135deg, #C8ABE6 0%, #DBD6F4 100%)', shadow: 'rgba(200, 171, 230, 0.25)', border: '#C8ABE6' },
                { gradient: 'linear-gradient(135deg, #4EB5A9 0%, #48ADB7 100%)', shadow: 'rgba(78, 181, 169, 0.25)', border: '#4EB5A9' },
                { gradient: 'linear-gradient(135deg, #5A7FC8 0%, #252E8A 100%)', shadow: 'rgba(90, 127, 200, 0.25)', border: '#5A7FC8' },
              ]
              ...
              return (
                ...
                >
                  ...
                  >
                    {/* Step Number Badge */}
                    <div className="absolute -top-4 -left-4 w-12 h-12 rounded-xl flex items-center justify-center text-white font-bold text-lg shadow-lg"
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#E6E5E1] via-[#F7F6F7] to-white dark:from-[#0E0E34] dark:to-[#252E8A]">
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            className="text-center mb-16 space-y-4"
          >
            <span className="text-sm font-bold uppercase tracking-wider" style={{ color: '#48ADB7' }}>Benefits</span>
            <h2 className="text-3xl sm:text-4xl font-display font-extrabold text-foreground tracking-tight">
              Why Choose TodoEvo
            </h2>
            <p className="text-base text-muted-foreground max-w-2xl mx-auto">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden bg-gradient-to-b from-white to-[#D6E6F2] dark:from-[#252E8A] dark:to-[#0E0E34]">
        ...
        >
          <div className="bg-white/80 dark:bg-[#252E8A]/80 backdrop-blur-xl p-12 lg:p-16 rounded-2xl border shadow-xl"
          ...
          >
            ...
            >
              ...
              >
                Join thousands of productive people who transformed their workflow. Start organizing today.
              </motion.p>
              ...
              >
                <CheckCircle2 className="h-4 w-4" style={{ color: '#4EB5A9' }} />
