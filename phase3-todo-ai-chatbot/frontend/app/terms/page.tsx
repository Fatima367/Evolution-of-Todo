        ...
        <div className="glass-card p-8 md:p-12 space-y-8 border border-white/20 dark:border-[#252E8A]/20">
          ...
          <div className="prose dark:prose-invert max-w-none text-gray-600 dark:text-gray-400 space-y-6">
            ...
            <section>
              ...
              <p>By accessing or using TodoEvo, you agree to be bound by these Terms of Service. If you disagree with any part of these terms, you may not access our service.</p>
            </section>
            ...
            <section>
              ...
              <p>The Service and its original content, features, and functionality are and will remain the exclusive property of TodoEvo and its licensors.</p>
            </section>
            ...
            <section>
              ...
              <p>In no event shall TodoEvo, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages resulting from your use of the service.</p>
            </section>
          </div>
