...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['user_id'], [USERS_ID], name=op.f('reminders_user_id_fkey')),
    ...
    sa.ForeignKeyConstraint(['user_id'], [USERS_ID], name=op.f('recurring_patterns_user_id_fkey')),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['user_id'], [USERS_ID], name=op.f('audit_logs_user_id_fkey')),
